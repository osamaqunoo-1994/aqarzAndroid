 ...
 */
public class RecyclerView_orders_my_requst extends RecyclerView.Adapter<RecyclerView_orders_my_requst.MyViewHolder> {
...
//        });
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_orders_my_order, parent, false);
