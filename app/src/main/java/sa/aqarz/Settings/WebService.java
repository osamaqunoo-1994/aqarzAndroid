...
//    public static String Domain = "https://apibeta.aqarz.sa/api/";
    ...
    public static String send_offer_Request = Domain + "send/offer/Request";
    ...
    public static String estate_Search = Domain + "estate/";
    public static String check_point = Domain + "check/point";
//    public static String provider_code_send = Domain + "provider/code/send";
