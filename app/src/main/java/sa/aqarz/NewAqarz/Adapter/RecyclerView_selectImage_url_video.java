 ...
 */
public class RecyclerView_selectImage_url_video extends RecyclerView.Adapter<RecyclerView_selectImage_url_video.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_selectImage_url_video(Context context, List<HomeModules_aqares.estate_file> alldatam) {
        alldata = alldatam;
