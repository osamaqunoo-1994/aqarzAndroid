 ...
 */
public class RecyclerView_type_work_rent extends RecyclerView.Adapter<RecyclerView_type_work_rent.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_type_work_rent(Context context, List<TypeModules> alldata) {
        RecyclerView_type_work_rent.alldata = alldata;
...
//                alldata.get(position).setIsselected(!alldata.get(position).isIsselected());
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_type_work, parent, false);
