 ...
 */
public class RecyclerView_selectVideoEdit extends RecyclerView.Adapter<RecyclerView_selectVideoEdit.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_selectVideoEdit(Context context, List<String> alldata) {
        RecyclerView_selectVideoEdit.alldata = alldata;
...
//                    AddAqarzStepsActivity.images.remove(position);
                    EditAqarzActivity.selectedVideos.remove(position);
