 ...
 */
public class RecyclerView_All_type_fillter extends RecyclerView.Adapter<RecyclerView_All_type_fillter.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_All_type_fillter(Context context, List<TypeModules> alldata) {
        RecyclerView_All_type_fillter.alldata = alldata;
