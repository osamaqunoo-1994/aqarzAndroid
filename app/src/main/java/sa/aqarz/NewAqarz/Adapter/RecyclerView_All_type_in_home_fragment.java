 ...
 */
public class RecyclerView_All_type_in_home_fragment extends RecyclerView.Adapter<RecyclerView_All_type_in_home_fragment.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_All_type_in_home_fragment(Context context, List<TypeModules> alldata) {
        RecyclerView_All_type_in_home_fragment.alldata = alldata;
