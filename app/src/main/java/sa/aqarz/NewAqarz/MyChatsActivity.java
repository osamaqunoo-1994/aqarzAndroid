...
public class MyChatsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManager1
                = new LinearLayoutManager(MyChatsActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    public void init() {
        WebService.loading(MyChatsActivity.this, true);

        init_volley();
        VolleyService mVolleyService = new VolleyService(mResultCallback, MyChatsActivity.this);
    ...
    public void init_volley() {
        ...
        mResultCallback = new IResult() {
            ...
            public void notifySuccess(String requestType, JSONObject response) {
                ...
                WebService.loading(MyChatsActivity.this, false);
...
//                                HomeModules ordersModulesm = gson.fromJson(mJson, HomeModules.class);
                            ...
                            chate.setAdapter(new RecyclerView_chat_main(MyChatsActivity.this, ordersModules));
                        ...
                        WebService.Make_Toast_color(MyChatsActivity.this, message, "error");
