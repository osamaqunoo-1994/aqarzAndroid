...
public class BottomSheetDialogFragment_Secess extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.bottom_tatus, container, false);
...
//                categories_bottomSheetDialogFragment.show(getSupportFragmentManager(), "");
    ...
    public BottomSheetDialogFragment_Secess(String status) {
        this.status = status;
