...
public class BottomSheetDialogFragment_DetailsAqares_orders_1 extends BottomSheetDialogFragment {

    demandsModules Homemodules_object;
...
//                categories_bottomSheetDialogFragment.show(getSupportFragmentManager(), "");
    ...
    public BottomSheetDialogFragment_DetailsAqares_orders_1(demandsModules Homemodules) {
