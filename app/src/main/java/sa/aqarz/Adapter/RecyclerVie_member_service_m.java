 ...
 */
public class RecyclerVie_member_service_m extends RecyclerView.Adapter<RecyclerVie_member_service_m.MyViewHolder> {
...
//            address = view.findViewById(R.id.address);
    ...
    public RecyclerVie_member_service_m(Context context, List<SettingsModules.service_types> alldata) {
        RecyclerVie_member_service_m.alldata = alldata;
