 ...
 */
public class RecyclerView_all_city_from_file extends RecyclerView.Adapter<RecyclerView_all_city_from_file.MyViewHolder> {
    public static List<AllCity_WithNib.data> alldata = new ArrayList<AllCity_WithNib.data>();
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_all_city_from_file(Context context, List<AllCity_WithNib.data> alldata) {
        RecyclerView_all_city_from_file.alldata = alldata;
...
//       holder.ratingbar.setStar(random);
        ...
        holder.text.setText(alldata.get(position).getCity_name() + "");
