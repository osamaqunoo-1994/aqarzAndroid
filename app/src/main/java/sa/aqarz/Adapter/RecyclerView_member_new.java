 ...
 */
public class RecyclerView_member_new extends RecyclerView.Adapter<RecyclerView_member_new.MyViewHolder> {
...
//        }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_member_new, parent, false);
