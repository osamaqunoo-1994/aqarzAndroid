 ...
 */
public class RecyclerView_service_new extends RecyclerView.Adapter<RecyclerView_service_new.MyViewHolder> {
...
//            address = view.findViewById(R.id.address);
    ...
    public RecyclerView_service_new(Context context, List<SettingsModules.service_types> alldata) {
...
//        }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_service_new, parent, false);
