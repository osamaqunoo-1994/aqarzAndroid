 ...
 */
public class RecyclerVie_member_course extends RecyclerView.Adapter<RecyclerVie_member_course.MyViewHolder> {
...
//            address = view.findViewById(R.id.address);
    ...
    public RecyclerVie_member_course(Context context, List<SettingsModules.service_types> alldata) {
        RecyclerVie_member_course.alldata = alldata;
