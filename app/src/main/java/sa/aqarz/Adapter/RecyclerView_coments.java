 ...
 */
public class RecyclerView_coments extends RecyclerView.Adapter<RecyclerView_coments.MyViewHolder> {
    public static List<HomeModules_aqares.rates> alldata = new ArrayList<HomeModules_aqares.rates>();
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_coments(Context context, List<HomeModules_aqares.rates> alldata) {
...
//       holder.ratingbar.setStar(random);
        ...
        holder.name.setText(alldata.get(position).getUser_name() + "");
        holder.note.setText(alldata.get(position).getNote() + "");
...
////
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_rate_coments, parent, false);
