 ...
 */
public class RecyclerView_select_city extends RecyclerView.Adapter<RecyclerView_select_city.MyViewHolder> {
...
//
        ...
        holder.text_city.setText(alldata.get(position).getName());
...
//
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_city_selected, parent, false);
