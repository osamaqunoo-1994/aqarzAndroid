 ...
 */
public class RecyclerView_price_range extends RecyclerView.Adapter<RecyclerView_price_range.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_price_range(Context context, List<price_range> alldata) {
        RecyclerView_price_range.alldata = alldata;
