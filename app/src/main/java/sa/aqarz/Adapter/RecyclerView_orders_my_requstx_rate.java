 ...
 */
public class RecyclerView_orders_my_requstx_rate extends RecyclerView.Adapter<RecyclerView_orders_my_requstx_rate.MyViewHolder> {
    public static List<MyRateModules> alldata = new ArrayList<MyRateModules>();
