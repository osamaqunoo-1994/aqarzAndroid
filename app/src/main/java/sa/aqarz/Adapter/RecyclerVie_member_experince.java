 ...
 */
public class RecyclerVie_member_experince extends RecyclerView.Adapter<RecyclerVie_member_experince.MyViewHolder> {
...
//            address = view.findViewById(R.id.address);
    ...
    public RecyclerVie_member_experince(Context context, List<SettingsModules.service_types> alldata) {
        RecyclerVie_member_experince.alldata = alldata;
