 ...
 */
public class RecyclerView_All_Employee extends RecyclerView.Adapter<RecyclerView_All_Employee.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_All_Employee(Context context, List<ComfortModules> alldata) {
        RecyclerView_All_Employee.alldata = alldata;
