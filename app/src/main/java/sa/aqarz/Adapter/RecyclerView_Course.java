 ...
 */
public class RecyclerView_Course extends RecyclerView.Adapter<RecyclerView_Course.MyViewHolder> {
...
//            address = view.findViewById(R.id.address);
    ...
    public RecyclerView_Course(Context context, List<SettingsModules.service_types> alldata) {
        RecyclerView_Course.alldata = alldata;
