 ...
 */
public class RecyclerView_All_number_rooooo extends RecyclerView.Adapter<RecyclerView_All_number_rooooo.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_All_number_rooooo(Context context, List<String> alldata) {
