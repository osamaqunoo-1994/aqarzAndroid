 ...
 */
public class RecyclerView_Type_RequstService extends RecyclerView.Adapter<RecyclerView_Type_RequstService.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_Type_RequstService(Context context, List<TypeModules> alldata) {
        RecyclerView_Type_RequstService.alldata = alldata;
...
//
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_type_add_service, parent, false);
