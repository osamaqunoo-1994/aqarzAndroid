 ...
 */
public class RecyclerView_city_side_menu extends RecyclerView.Adapter<RecyclerView_city_side_menu.MyViewHolder> {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_city_side_menu(Context context, List<CityModules> alldata) {
        RecyclerView_city_side_menu.alldata = alldata;
