 ...
 */
public class RecyclerView_All_Type_in_map extends RecyclerView.Adapter<RecyclerView_All_Type_in_map.MyViewHolder> {
    ...
    public void addNewData(List<TypeModules> alldata1) {
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_All_Type_in_map(Context context, List<TypeModules> alldata) {
