 ...
 */
public class RecyclerView_orders_my_requstx_det extends RecyclerView.Adapter<RecyclerView_orders_my_requstx_det.MyViewHolder> {
    public static List<deferredInstallmentModules> alldata = new ArrayList<deferredInstallmentModules>();
