 ...
 */
public class RecyclerView_order_rate extends RecyclerView.Adapter<RecyclerView_order_rate.MyViewHolder> {
    public static List<RateModules> alldata = new ArrayList<RateModules>();
...
//        System.out.println(alldata.get(position).getAreaFrom() + " - " + alldata.get(position).getAreaTo());
        holder.name_estate.setText(alldata.get(position).getRateName() + "");
...
//        });
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_orders_rate, parent, false);
