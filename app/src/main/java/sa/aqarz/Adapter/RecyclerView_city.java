...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_city(Context context, List<AllCityModules.City> alldata) {
        RecyclerView_city.alldata = alldata;
...
//
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_city2, parent, false);
