 ...
 */
public class RecyclerView_orders_demandsx_favorit extends RecyclerView.Adapter<RecyclerView_orders_demandsx_favorit.MyViewHolder> {
...
//
        ...
        holder.price.setText(alldata.get(position).getEstate_price_range() + "");
//        holder.view_type.setText(alldata.get(position).getDirEstate());
        holder.space.setText(alldata.get(position).getStreet_view_range() + "");
...
//
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_ordersxx_favo, parent, false);
