 ...
 */
public class RecyclerView_all_nib_from_file extends RecyclerView.Adapter<RecyclerView_all_nib_from_file.MyViewHolder> {
    public static List<AllCity_WithNib.neighborhoods> alldata = new ArrayList<AllCity_WithNib.neighborhoods>();
...
////            simpleRatingBar = view.findViewById(R.id.simpleRatingBar);
    ...
    public RecyclerView_all_nib_from_file(Context context, List<AllCity_WithNib.neighborhoods> alldata) {
        RecyclerView_all_nib_from_file.alldata = alldata;
