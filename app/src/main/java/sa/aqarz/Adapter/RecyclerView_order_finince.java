 ...
 */
public class RecyclerView_order_finince extends RecyclerView.Adapter<RecyclerView_order_finince.MyViewHolder> {
    public static List<financeModules> alldata = new ArrayList<financeModules>();
...
//
        ...
        holder.price.setText(alldata.get(position).getEstatePrice() + "");
...
//        System.out.println(alldata.get(position).getAreaFrom() + " - " + alldata.get(position).getAreaTo());
        ...
        holder.address.setText(alldata.get(position).getCityName() + "");
...
//        });
//
        holder.add_favorite.setVisibility(View.GONE);
...
//        });
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_my_order_rent_rate_finince, parent, false);
