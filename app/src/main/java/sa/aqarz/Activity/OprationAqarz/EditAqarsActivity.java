...
public class EditAqarsActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (city_l.getText().toString().equals("")) {
                    ...
                    bottomSheetDialogFragment_selectNeighborhoods.addItemClickListener(new BottomSheetDialogFragment_SelectNeighborhoods.ItemClickListener() {
                        @Override
                        public void onItemClick(String id_city, String city_naem,String lat,String lng) {
                            nib_id = id_city + "";
...
//------------------------------------------------------------------------------------
        ...
        RecyclerView_All_opration_bottom_sheet recyclerView_all_opration_bottom_sheet = new RecyclerView_All_opration_bottom_sheet(EditAqarsActivity.this, type_list);
        ...
        RecyclerView_date_select recyclerView_date_select = new RecyclerView_date_select(EditAqarsActivity.this, date_list);
...
//-------------------------------------------------------------------------------------------------
        ...
        try {
            MapsInitializer.initialize(EditAqarsActivity.this.getApplicationContext());
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                googleMap.getUiSettings().setRotateGesturesEnabled(true);
                ...
                googleMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                    ...
                    public void onMapClick(LatLng latLng) {
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                            if (ContextCompat.checkSelfPermission(EditAqarsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {


                                // No explanation needed, we can request the permission.
                                requstcode = 11;

                                ActivityCompat.requestPermissions(EditAqarsActivity.this,
...
//                                }
                                ...
                                requstcode = 11;
                                is_place = true;
                                Intent intent = new Intent(EditAqarsActivity.this, SelectLocationActivity.class);
        ...
        Places.initialize(EditAqarsActivity.this, getResources().getString(R.string.google_key2));
        placesClient = Places.createClient(EditAqarsActivity.this);
...
//                investment.getCompoundDrawables()[0].setTint(Color.WHITE);
        ...
        select_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (ContextCompat.checkSelfPermission(EditAqarsActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
...
//                        selectIamgeList.size() == 0 |
                    ...
                    WebService.Make_Toast_color(EditAqarsActivity.this, getResources().getString(R.string.fillallfileds) + "", "error");


                } else if (lat.equals("0.0")) {


                    new AlertDialog.Builder(EditAqarsActivity.this)
                ...
                if (requestType.equals("deleteImg_estate")) {
                    ...
                    try {
                        ...
                        if (status) {
                            ...
                            if (requestType.equals("single_estat")) {
...
//                            comfort_RecyclerView.setLayoutManager(new FlowLayoutManager().maxItemsPerLine(3));
                                ...
                                RecyclerView_All_Comfort_in_fragment recyclerView_all_comfort_in_fragment = new RecyclerView_All_Comfort_in_fragment(EditAqarsActivity.this, comfort_listxx);
                            ...
                            WebService.Make_Toast_color(EditAqarsActivity.this, message, "error");
                        }
            ...
            public void notifyError(String requestType, VolleyError error) {
                ...
                WebService.loading(EditAqarsActivity.this, false);
                WebService.Make_Toast_color(EditAqarsActivity.this, error.getMessage(), "error");
...
//                Upload_image(requestParams, images);
                ...
                images_RecyclerView.setAdapter(new RecyclerView_selectImage(EditAqarsActivity.this, selectIamgeList));
...
//                    String code = responseBody.getString("code");
                    ...
                    if (status.equals("true")) {
                        ...
                        WebService.Make_Toast_color(EditAqarsActivity.this, message, "success");

                    } else {


                        WebService.Make_Toast(EditAqarsActivity.this, message);
                    }
...
//                    .start();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (ContextCompat.checkSelfPermission(EditAqarsActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ImagePicker.with(EditAqarsActivity.this)
                    .setFolderMode(true)
                    .setFolderTitle("Album")
