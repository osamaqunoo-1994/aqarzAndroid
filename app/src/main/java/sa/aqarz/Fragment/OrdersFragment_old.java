...
public class OrdersFragment_old extends Fragment {
    ...
    TextView market_number;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_orders_old, container, false);
...
//                }
    ...
    public void init(View v) {
        ...
        market_number = v.findViewById(R.id.market_number);


        market_number.setText(Settings.getSettings().getMarketDemands() + "");
        cumber_req.setText(Settings.getSettings().getRequestFund() + "");
...
//        });
    ...
    public static OrdersFragment_old newInstance(String text) {

        OrdersFragment_old f = new OrdersFragment_old();
        Bundle b = new Bundle();
